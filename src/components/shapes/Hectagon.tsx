...
function Mouth(props: TShapeProps) {
  return (
    <svg
...
// Halloween Edition - Spidy web
export function SpidyWeb(props: TShapeProps) {
  ...
  return (
    ...
    >
      <path
        ...
        d="M 0,55 L25,10 L75,10 L100,55 L75,100 L25,100 z"
        strokeWidth="4"
      />
    </svg>
  );
...
export function ThemedHectagon(props: TShapeProps) {
